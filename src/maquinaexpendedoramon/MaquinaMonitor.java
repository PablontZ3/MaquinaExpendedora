...
public class MaquinaMonitor {
	...
	public synchronized void añadirDinero(Cartera carteraPersona,String nombre,int pSeleccionado) {
		...
		insertarDinero(0.1,precioProducto,carteraPersona, nombre);
		insertarDinero(0.2,precioProducto,carteraPersona, nombre);
		insertarDinero(0.5,precioProducto,carteraPersona, nombre);
		insertarDinero(1,precioProducto,carteraPersona, nombre);
		insertarDinero(2,precioProducto,carteraPersona, nombre);
	 ...
	 */
	private void insertarDinero(double vMoneda,double precioPro,Cartera cartera, String nombre) {
		int cMoneda= 0;
